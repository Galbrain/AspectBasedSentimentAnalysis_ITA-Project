                ...
                for sentence in sentences:
                    ...
                    if len(occurences_g) > 0:
                        for occurence in occurences_g:
                            ...
                            graphics_dict = {'sentiment': review['rating']['Grafik'], 'aspect': 'GRAPHICS', 'original-entity': occurence}
                    ...
                    if len(occurences_s) > 0:
                        for occurence in occurences_s:
                            ...
                            sound_dict = {'sentiment': review['rating']['Sound'], 'aspect': 'SOUND', 'original-entity': occurence}
                    ...
                    if len(occurences_c) > 0:
                        for occurence in occurences_c:
                            ...
                            controls_dict = {'sentiment': review['rating']['Steuerung'], 'aspect': 'CONTROLS', 'original-entity': occurence}
                    ...
                    if len(occurences_a) > 0:
                        for occurence in occurences_a:
                            ...
                            atmosphere_dict = {'sentiment': review['rating']['Atmosph\u00e4re'], 'aspect': 'ATMOSPHERE', 'original-entity': occurence}
                            opinions.append(atmosphere_dict)
                    
                    if (opinions != []):
                        sentence_dict = {'opinions': opinions, 'text': sentence} #add id of review
